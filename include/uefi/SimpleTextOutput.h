...
typedef EFI_STATUS (VOID *EFI_TEXT_RESET) (EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This, BOOLEAN ExtendedVerification);
...
typedef EFI_STATUS (VOID *EFI_TEXT_TEST_STRING) (EFI_SIMPLE_TEXT_INPUT_PROTOCOL *This, CHAR16 *String);

// EFI_TEXT_QUERY_MODE (Page 521)
typedef EFI_STATUS (VOID *EFI_TEXT_QUERY_MODE) (EFI_SIMPLE_TEXT_INPUT_PROTOCOL *This, UINTN ModeNumber, UINTN *Columns, UINTN *Rows);
