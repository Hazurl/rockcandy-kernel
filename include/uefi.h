...
// Protocol GUIDs
#define EFI_FILE_INFO_GUID  {0x09576e92,0x6d3f,0x11d2,\
 {0x8e, 0x39,0x00,0xa0,0xc9,0x69,0x72,0x3b}}
 //{0x09576e92, 0x6d3f, 0x11d2, {0x39,0x00,0xa0,0xc9,0x69,0x72,0x3b, 0x00}} // Page 598
#define EFI_GRAPHICS_OUTPUT_PROTOCOL_GUID {0x9042a9de,0x23dc,0x4a38, {0x96,0xfb,0x7a,0xde,0xd0,0x80,0x51,0x6a}} // Page 551
#define EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_GUID {0x0964e5b22,0x6459,0x11d2, {0x8e,0x39,0x00,0xa0,0xc9,0x69,0x72,0x3b}} // Page 577

// Status Codes(Page 2286)
#if __SIZEOF_POINTER__ == 8
#define EFI_HIGH_BIT (1ull << 63)
#else
#error "Unable to define EFI_HIGH_BIT"
#endif

#define EFI_ERROR(status) ((status) & EFI_HIGH_BIT)
#define EFI_WARN(status) (status)
